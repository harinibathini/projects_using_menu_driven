...
public class Operations {
    ...
    public void addBankAccount(){
        ...
        switch(choice) {
            case 1:
                ...
                bank.add(new User(name,address,phoneNumber,emailId, accType,bal,accNo));
                System.out.println("++++++++++++++++++++++++++++++++");
    ...
    public void deposit(){
        ...
        if (accExist) {
            for(User bank1 : bank) {
                ...
                bank1.balance = bank1.balance + deposit;
                System.out.println("Updated balance is: " + bank1.balance);
            }
        } else if(!accExist){
            try {
        ...
        if (accExist) {
            ...
            for(User bank1 : bank) {
                if (bank1.balance - withdraw < 0) {
                    ...
                    bank1.balance = bank1.balance - withdraw;
                    System.out.println("Updated balance is: " + bank1.balance);
                }
            }
        } else {
    ...
    public void displayDetails(){
        Collections.sort(bank, new Comparator<User>(){
